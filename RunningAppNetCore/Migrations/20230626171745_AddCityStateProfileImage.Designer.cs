...
namespace RunningAppNetCore.Migrations
{
    ...
    [Migration("20230626171745_AddCityStateProfileImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RunningAppNetCore.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RunningAppNetCore.Models.AppUser", b =>
                {
                    ...
                    b.Property<string>("ProfileUmageUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RunningAppNetCore.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RunningAppNetCore.Models.AppUser", b =>
                {
                    b.HasOne("RunningAppNetCore.Models.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("RunningAppNetCore.Models.Club", b =>
                {
                    ...
                    b.HasOne("RunningAppNetCore.Models.AppUser", "AppUser")
                        .WithMany("Clubs")
